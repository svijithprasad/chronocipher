...
export const puzzles = [
  ...
  },
  {
    ...
    story: "Level 03: Time calculates its own trajectory.",
    question: "Solve: ∫₀¹ (3x² + 2x) dx = ?",
    answer: "2",
    hint: "Evaluate at boundaries. What lies between zero and one?",
    clue: "VAULT",
    time: 50,
    difficulty: "hard",
  },
  ...
  // Level 20: MINI-GAME - Pattern Match
  {
    ...
    difficulty: "hard",
    patterns: [
      { id: 1, symbol: "◆", color: "cyan" },
      { id: 2, symbol: "◇", color: "purple" },
      { id: 3, symbol: "★", color: "cyan" },
      { id: 4, symbol: "✚", color: "purple" },
      { id: 1, symbol: "◆", color: "cyan" },
      { id: 2, symbol: "◇", color: "purple" },
      { id: 3, symbol: "★", color: "cyan" },
      { id: 4, symbol: "✚", color: "purple" },
  ...
  },
  {
    ...
    question: "Atbash cipher decode: ZYXWVUTSRQ → ?",
    answer: "ABCDEFGHIJ",
    hint: "A=Z, B=Y, etc.",
    clue: "MIRROR",
    time: 45,
  ...
  },
  {
    ...
    story: "Level 24: Equations root themselves in paradox.",
    question: "Find the sum of roots: x³ - 6x² + 11x - 6 = 0",
    answer: "6",
    hint: "By Vieta's formulas, what balances the chaos?",
    clue: "HARMONY",
    time: 50,
    difficulty: "hard",
  },
  ...
  },
  {
    ...
    story: "Level 26: Reality is mathematical.",
    question: "◆ = 3, ◇ = 5, Sum of both: ◆ + ◇ = ?",
    answer: "8",
  ...
  },
  {
    ...
    question: "Vigenère (key='KEY'): PLAINTEXT → ? (first 5 letters)",
    answer: "ZIHVL",
  ...
  },
  {
    ...
    story: "Level 38: Beauty in mathematics.",
    question: "Golden Ratio ≈ ? (two decimals)",
    answer: "1.62",
    hint: "(1+√5)/2",
    clue: "GOLDEN",
    time: 45,
